                    ...
                    echo '<!--item-->';
                        echo '<div class="panel panel-default">';
                            echo '<div class="panel-heading" role="tab" id="h20">';
                                ...
                                echo '</h4>';
                            echo '</div>';
                            echo '<div id="c-'.$ii.'" class=" collapse " role="tabpanel" aria-labelledby="h20" data-parent="#accordion">';
...
//							echo '<h2 class="mb-0">';
//								echo '<button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#c-'.$ii.'" aria-expanded="true" aria-controls="collapseOne">';
//									echo $line['name'];
//								echo '</button>';
//							echo '</h2>';
//						echo '</div>';
//
//						echo '<div id="c-'.$ii.'" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">';
