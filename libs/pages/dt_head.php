...
<div class="conrainer-fluid mosaic_cover" onClick="open_pop();">
	<div class="rows">
		<div class="col-md-6 col-sm-6 col-xs-12 nopad">
        	<img itemprop="image photo" class="cover_mosa lazy" src="<?php echo imageP($mosaic[0]['img']) ?>" width="100%" alt="<?php echo $vi_name_1[0].' '.$mosaic[0]['name'];?>">
            <?php echo $button;?>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12 nopad">
        	<div class="col-md-6  col-sm-6 col-xs-3 nopad"><img itemprop=" photo" class="cover_mosa lazy" src="<?php echo imageP($mosaic[1]['img']) ?>" width="100%" alt="<?php echo $vi_name_1[0].' '.$mosaic[1]['name'];?>"></div>
            <div class="col-md-6 col-sm-6 col-xs-3 nopad"><img itemprop=" photo" class="cover_mosa lazy" src="<?php echo imageP($mosaic[2]['img']) ?>" width="100%" alt="<?php echo $vi_name_1[0].' '.$mosaic[2]['name'];?>"></div>
            <div class="col-md-6 col-sm-6 col-xs-3 nopad"><img itemprop=" photo" class="cover_mosa lazy" src="<?php echo imageP($mosaic[3]['img']) ?>" width="100%" alt="<?php echo $vi_name_1[0].' '.$mosaic[3]['name'];?>"></div>
            <div class="col-md-6 col-sm-6 col-xs-3 nopad"><img itemprop=" photo" class="cover_mosa lazy" src="<?php echo imageP($mosaic[4]['img']) ?>" width="100%" alt="<?php echo $vi_name_1[0].' '.$mosaic[4]['name'];?>"></div>
        </div>    
    </div>
</div>
