...
<div class="mg-page-titles webss " style="margin-top: 48px;"><!--parallax-->
    ...
    <div class="container">
        <div class="row justify-content-center">
        	...
        	<div class="col-md-12  conbox">
                ...
                <div class="row justify-content-center">
					<div class="col-10  det text-center" style="padding-bottom:30px;">
            ...
            <div class="col-md-10 ">
                ...
                <div class="row top30">
                    <div class="row col-md-12 nopad top30">
