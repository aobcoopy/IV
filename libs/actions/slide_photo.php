        ...
        <div  data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:400px;" >
			...
			foreach($slide as $img)
			{
				...
				//echo 'sfdsfsdfsdfsfdsfsdfsdfsfdsfsdfsdfsfdsfsdfsdfsfdsfsdfsdfsfdsfsdfsdfsfdsfsdfsdf';
					echo '<img data-u="image"  itemprop="photo" src="'.imageP($img['img']).'" alt="'.$vi_name[0].$img['name'].' '.$i.'" style="margin-top:33px;" />';
					//echo '<img data-u="image"  itemprop="photo" src="'.imagePath($img['img']).'" alt="'.$vi_name[0].$img['name'].' '.$i.'" style="margin-top:33px;" />';
					//echo '<br><br>';
					echo '<img data-u="thumb" src="'.imageP($img['img']).'" alt="'.$vi_name[0].$img['name'].' '.$i.'" />';
