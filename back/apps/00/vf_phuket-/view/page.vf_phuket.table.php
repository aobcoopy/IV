	...
	<div class="panel panel-default">
        ...
        <div>
                  ...
                  while($des = $dbc->Fetch($sql_destinations))
                  {
                      ...
                      $act = ($i==0)?'active':'';
                      echo '<li role="presentation" class="'. $act.' li_des"><a href="#'.$des_slug.'" aria-controls="'.$des_slug.'" role="tab" data-toggle="tab">'.$des['name'].'</a>';
          ...
          <div class="tab-content">
			...
			{
				$act = ($x==0)?'active':'';
				echo '<div role="tabpanel" class="tab-pane '.$act.'" id="'.$deslist.'">';
	...
	?>
		...
		$("#tblSlide_<?php echo $deslist_2;?>").DataTable({
			...
			"createdRow": function ( row, data, index ) {
				...
				s += ' ';
				s += fn.engine.datatable.button('btn-warning','fa-history','fn.app.vf_phuket.customer_history('+data[0]+','+data[5]+')','Customer History',' ');
				s += ' ';
